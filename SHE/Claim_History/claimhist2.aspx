...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel runat="server" Visible="false" ID="mainpanel2">
        ...
        <div class="container background-color: #ffffff ; ">
            <div class="row">
                <div class="col-12 ">
                    <table runat="server" class="table border-color: #ffffff;">
                        <tr>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <asp:Button runat="server" ID="btnIconClick1" OnClick="IconClick_ServerClick" Style="display: none;" />
                Page
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-1-square-fill" viewBox="0 0 16 16" onclick="document.getElementById('<%= btnIconClick1.ClientID %>').click()">
                ...
                <asp:Button runat="server" ID="btnIconClick2" OnClick="IconClick_ServerClick2" Style="display: none;" OnClientClick="return clientFunctionValidationFinished()"/>
                ...
                <asp:Button runat="server" ID="btnIconClick3" OnClick="IconClick_ServerClick3" Style="display: none;"  OnClientClick="return clientFunctionValidationFinished()" />
                ...
                <asp:Button runat="server" ID="btnIconClick4" OnClick="IconClick_ServerClick4" Style="display: none;"  OnClientClick="return clientFunctionValidationFinished()" />
